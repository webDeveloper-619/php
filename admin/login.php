...
<!-- Mirrored from coderthemes.com/adminto/layouts/vertical/pages-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Sep 2020 10:20:34 GMT -->
<head>
        <meta charset="utf-8" />
                            ...
                            <div class="card-body p-4">
                                ...
                                <form action="checklogin.php" method="POSt">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="text" id="emailaddress" required="" name="name" placeholder="Enter your email">
                                    </div>
